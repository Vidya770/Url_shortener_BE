...
module.exports.Signup = async (req, res) => {
    try {
        ...
        const link = `https://shortening-url-app-frontend.netlify.app/UrlShortener/account_activation/${randomString}`;
...
module.exports.PasswordResetLink = async (req, res) => {
    try {
        ...
        const link = `https://shortening-url-app-frontend.netlify.app/UrlShortener/UpdatePassword/${randomString}`;
